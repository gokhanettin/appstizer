...
DATABASES = {
    'default': {
        ...
        'NAME': '/app/askbot.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'ab738df021fcc027d6f36260669c4b30'
...
logging.basicConfig(
    filename=os.path.join('/data', LOG_FILENAME),
